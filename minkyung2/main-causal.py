...
print("Importing Accelerator library - initialize module.")
...
def parser_args():
    ...
    parser.add_argument('--output', default='./out/train_Feb/{}'.format(
...
def train(train_loader, model, ema_m, criterion, optimizer, scheduler, epoch, args, logger):
    ...
    for i, (images, target) in enumerate(tqdm(train_loader)):
        ...
        # if i==0:
        #     print(f"train: GPU id for images,target in trainloader: {images.get_device()}, {target.get_device()}")
...
def validate(val_loader, model, criterion, args, logger, epoch):
    ...
    with torch.no_grad():
        ...
        for i, (images, target) in enumerate(val_loader):
            ...
            # if i==0:
            #     print(f"valid: for images,target in validloader -: {images.get_device()}, {target.get_device()}")
