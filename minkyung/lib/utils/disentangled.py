...
from torch.nn.functional import handle_torch_function, has_torch_function, has_torch_function_unary
from torch.nn.modules.linear import NonDynamicallyQuantizableLinear
# from torch.nn.modules.linear import Linear as linear
from torch.nn.init import xavier_uniform_, xavier_normal_, constant_, kaiming_uniform_, _calculate_fan_in_and_fan_out,uniform_
...
def multi_head_attention_forward_disentangled(
    ...
    if need_weights:
        ...
        if not is_batched:
            ...
            attn_output = attn_output_inverted.squeeze(1)
...
class MultiheadAttentionDisentangled(torch.nn.Module):
    ...
    Outputs:
        ...
        if not self._qkv_same_embed_dim:
            attn_output, attn_output_inverted, attn_output_weights = multi_head_attention_forward_disentangled(
