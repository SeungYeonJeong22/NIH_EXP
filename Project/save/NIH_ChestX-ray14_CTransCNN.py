...
data = dict(
    ...
    train=dict(
        ...
        data_prefix='./open_data/chest14/',
        ann_file='./open_data/chest14/train_val_labels.txt',
        classes='./open_data/chest14/add72_chest14_classes.txt',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='Resize',
    ...
    test=dict(
        type='My_MltilabelData',
        data_prefix='./open_data/chest14/',
        ann_file='./open_data/chest14/test_labels.txt',
        classes='./open_data/chest14/add72_chest14_classes.txt',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
